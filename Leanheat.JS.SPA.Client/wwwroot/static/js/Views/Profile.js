...
export default class extends AbstractView {
 ...
 <form id="updateUserForm" onsubmit="return UserFormIsValid(this.id)">
       <div name="registerContainer" class="inputContainer">
        ...
        <button name="triggerSubmit" type="submit" id="registerBtn" onmousedown="javascript:SubmitUserForm('updateUserForm','/Account/UpdateUser?');"  class="blue-dark-button">Enter</button>    
           </div>
   </form>
