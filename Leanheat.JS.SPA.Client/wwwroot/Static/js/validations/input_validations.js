import { IdentityPost } from "/static/js/api/crud/post.js";
          ...
          // ===================== Allow - Only Numbers ===============================================================
         export function NumValidate(key) 
         {
         ...
         export function LettersValidate(key) 
         {
              var keycode = (key.which) ? key.which : key.keyCode;
          ...
          export function ValidateFromTo(a, b) 
          {
          ...
          // ================================ Password Show Hide ===========================================================
          export function ShowPassword(checkBox, passInputID, repeatPassInputID)
          {
          ...
          // --------------------- EMAIL Validation -------------------------------------------------------
          export function ValidateEmail(currentInput)
          {
          ...
          // --------------------- PASSWORD Validation  -------------------------------------------------------
          export function ValidateCurrentPasswordInput(currentPasswordInput)
          {
          ...
          export  function ValidateLoginPasswordInput(currentPasswordInput)
          {
              if (currentPasswordInput.value.length >= 6)
              {
          ...
          export function ValidatePasswordCompare(passInputID, repeatPassInputID)
          {
          ...
          // --------------------- Name Validation -------------------------------------------------------
          export function ValidateName(currentNameInput)
          {
          ...
          // --------------------- AGE Validation -------------------------------------------------------
          export function ValidateAge(currentAgeInput) {
          ...
          export function ValidatePhoneNumber(currentPhonenumberInput)
          {
          ...
          export function UserFormIsValid(formID)
          {     
          ...
          export async function SubmitUserForm(formID, url)
          {
          ...
          // ================================ Login - Validate ===========================================================
          export  function ValidateLogin(formID)
          {
          ...
          export function SubmitLogin(formID, url)
          {
